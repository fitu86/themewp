...
// Additional info
if ( carz_is_off( carz_get_theme_option( 'header_mobile_hide_info' ) ) ) {
	$carz_info = carz_get_theme_option( 'header_mobile_additional_info' );
	if ( '' != $carz_info ) {
	...
	<div class="content_wrap">
		<div class="columns_wrap columns_fluid">
			<div class="sc_layouts_column sc_layouts_column_align_left sc_layouts_column_icons_position_left sc_layouts_column_fluid column-1_3">
				<?php
				// Logo
				if ( carz_is_off( carz_get_theme_option( 'header_mobile_hide_logo' ) ) ) {
					?>
					<div class="sc_layouts_item">
						<?php
						set_query_var( 'carz_logo_args', array( 'type' => 'mobile_header' ) );
				...
				if ( carz_exists_trx_addons() ) {
					...
					if ( carz_is_off( carz_get_theme_option( 'header_mobile_hide_login' ) ) ) {
						ob_start();
						do_action(
							'carz_action_login', array(
								'text_login'  => false,
								'text_logout' => false,
							)
						);
					...
					// Display cart button
					if ( carz_is_off( carz_get_theme_option( 'header_mobile_hide_cart' ) ) ) {
						ob_start();
					...
					if ( carz_is_off( carz_get_theme_option( 'header_mobile_hide_search' ) ) ) {
						ob_start();
						do_action(
							'carz_action_search',
							array(
