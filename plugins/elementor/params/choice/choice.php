 ...
 */
class Carz_Elementor_Control_Choice extends \Elementor\Base_Data_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'carz-elementor-choice-control', carz_get_file_url( 'plugins/elementor/params/choice/choice-control.js'), array('jquery'), null, true );
	}
						...
						_.each( data.options, function( params, slug ) {
							print( ( params.new_row !== undefined
									...
									+ '<span tabindex="0" class="carz_list_choice_item'
												+ ( ( slug == data.controlValue && '' !== data.controlValue ) || ( 'inherit' == slug && '' === data.controlValue ) ? ' carz_list_active' : '' )
												+ '"'
										+ ' data-choice="' + slug + '"'
