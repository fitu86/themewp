...
if ( ! function_exists( 'carz_woocommerce_get_css' ) ) {
	add_filter( 'carz_filter_get_css', 'carz_woocommerce_get_css', 10, 2 );
	function carz_woocommerce_get_css( $css, $args ) {
...
$fdir = carz_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
