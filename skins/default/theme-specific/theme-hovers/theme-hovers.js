...
jQuery( document ).on(
	'action.init_hidden_elements', function(e, cont) {
		...
		if (CARZ_STORAGE['button_hover'] && CARZ_STORAGE['button_hover'] != 'default') {
			jQuery(
				// Tag 'button'
			...
			).addClass( 'sc_button_hover_just_init sc_button_hover_' + CARZ_STORAGE['button_hover'] );

			// Add button's hover class if not based on :before or :after elements (like 'sc_button_hover_arrow')
			if (CARZ_STORAGE['button_hover'] != 'arrow') {
				jQuery(
					// Form buttons
			...
			).removeClass( 'sc_button_hover_' + CARZ_STORAGE['button_hover'] );
