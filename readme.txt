...
Please install and activate it before starting to use the theme Carz.
...
Theme documentation is available on https://doc.themerex.net/carz/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Carz is Fontello.
